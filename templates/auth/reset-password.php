...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($action ?? '/reset-password'); ?>">
            ...
            <input type="hidden" name="token" value="<?php echo htmlspecialchars($token ?? ''); ?>" class="token-field">
