...
$title = 'Annotations Rapport';
$pageTitle = 'Annotations Rapport';
$currentPage = 'commission-evaluations';
$breadcrumbs = [
    ['label' => 'Commission', 'url' => '/modules/commission'],
    ['label' => 'Evaluations', 'url' => '']
];
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Interface d'annotations sur le rapport</p>
    </div>
    <div class="page-actions">
        <a href="/modules/commission/evaluations/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/commission/evaluations/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/commission/evaluations/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('evaluations', '/') + 2) . 'layouts/app.php';
