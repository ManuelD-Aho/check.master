...
$pageTitle = 'Résultats des Votes';
$currentPage = 'commission-votes';
$breadcrumbs = [
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Résultats détaillés des votes</p>
    </div>
    <div class="page-actions">
        <a href="/modules/commission/votes/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/commission/votes/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/commission/votes/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('votes', '/') + 2) . 'layouts/app.php';
