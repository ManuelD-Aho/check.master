...
$pageTitle = 'Archives Sessions';
$currentPage = 'commission-archives';
$breadcrumbs = [
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Archives des sessions passées</p>
    </div>
    <div class="page-actions">
        <a href="/modules/commission/archives/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/commission/archives/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/commission/archives/edit?id=<?= $item['id'] ?>" 
