...
$title = 'Saisir Notes';
$pageTitle = 'Saisir Notes';
$currentPage = 'soutenance-notes';
$breadcrumbs = [
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Saisie des notes de soutenance</p>
    </div>
    <div class="page-actions">
        ...
        <a href="/modules/soutenance/notes/create" class="btn btn-primary">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/soutenance/notes/show?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                            ...
                            <a href="/modules/soutenance/notes/edit?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                               title="Modifier">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="btn-action text-red-600" 
                                    title="Supprimer"
                                    onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cet élément ?')) { window.location.href='/modules/soutenance/notes/delete?id=<?= $item['id'] ?>'; }">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
