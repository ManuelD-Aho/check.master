...
$title = 'Invitations Jury';
$pageTitle = 'Invitations Jury';
$currentPage = 'soutenance-jury';
$breadcrumbs = [
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Gestion des invitations jury</p>
    </div>
    <div class="page-actions">
        ...
        <a href="/modules/soutenance/jury/create" class="btn btn-primary">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/soutenance/jury/show?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                            ...
                            <a href="/modules/soutenance/jury/edit?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                               title="Modifier">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="btn-action text-red-600" 
                                    title="Supprimer"
                                    onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cet élément ?')) { window.location.href='/modules/soutenance/jury/delete?id=<?= $item['id'] ?>'; }">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
