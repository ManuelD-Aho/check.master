...
$currentPage = 'scolarite-inscriptions';
$breadcrumbs = [
    ['label' => 'Scolarite', 'url' => '/modules/scolarite'],
    ['label' => 'Inscriptions', 'url' => '']
];
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Créer une nouvelle inscription</p>
    </div>
    <div class="page-actions">
        ...
        <a href="/modules/scolarite/inscriptions/create" class="btn btn-primary">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/scolarite/inscriptions/show?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                            ...
                            <a href="/modules/scolarite/inscriptions/edit?id=<?= $item['id'] ?>" 
                               class="btn-action" 
                               title="Modifier">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="btn-action text-red-600" 
                                    title="Supprimer"
                                    onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cet élément ?')) { window.location.href='/modules/scolarite/inscriptions/delete?id=<?= $item['id'] ?>'; }">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
$depth = substr_count('inscriptions', '/') + 2;
