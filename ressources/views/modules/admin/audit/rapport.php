...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Rapports et statistiques d'audit</p>
    </div>
    <div class="page-actions">
        <a href="/modules/admin/audit/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/admin/audit/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/admin/audit/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('audit', '/') + 2) . 'layouts/app.php';
