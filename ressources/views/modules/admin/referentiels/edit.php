...
$title = 'Modifier Référentiel';
$pageTitle = 'Modifier Référentiel';
$currentPage = 'admin-referentiels';
$breadcrumbs = [
    ['label' => 'Admin', 'url' => '/modules/admin'],
    ['label' => 'Referentiels', 'url' => '']
];
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Modifier un référentiel</p>
    </div>
    <div class="page-actions">
        <a href="/modules/admin/referentiels/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/admin/referentiels/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/admin/referentiels/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('referentiels', '/') + 2) . 'layouts/app.php';
