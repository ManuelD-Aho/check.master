...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Modifier les informations d'un utilisateur</p>
    </div>
    <div class="page-actions">
        <a href="/modules/admin/utilisateurs/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/admin/utilisateurs/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/admin/utilisateurs/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('utilisateurs', '/') + 2) . 'layouts/app.php';
