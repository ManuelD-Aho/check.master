...
$title = 'Archives Système';
$pageTitle = 'Archives Système';
$currentPage = 'admin-archives';
$breadcrumbs = [
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-description">Archives et sauvegardes système</p>
    </div>
    <div class="page-actions">
        <a href="/modules/admin/archives/create" class="btn btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-buttons">
                            <a href="/modules/admin/archives/show?id=<?= $item['id'] ?>" 
                            ...
                            <a href="/modules/admin/archives/edit?id=<?= $item['id'] ?>" 
...
require __DIR__ . '/' . str_repeat('../', substr_count('archives', '/') + 2) . 'layouts/app.php';
